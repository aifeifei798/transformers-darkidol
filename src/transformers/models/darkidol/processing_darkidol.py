...
class DarkidolImagesKwargs(ImagesKwargs):
...
class DarkidolProcessorKwargs(ProcessingKwargs, total=False):
    images_kwargs: DarkidolImagesKwargs
    _defaults = {
        "text_kwargs": {
            "padding": False,
...
class DarkidolProcessor(ProcessorMixin):
    ...
    def __call__(
        ...
        videos=None,
        audio=None,
        **kwargs: Unpack[DarkidolProcessorKwargs],
    ) -> BatchFeature:
        if text is None and images is None:
            raise ValueError("Provide at least one of `text` or `images`.")

        output_kwargs = self._merge_kwargs(
            DarkidolProcessorKwargs,
