...
class DarkidolFastImageProcessorKwargs(DefaultFastImageProcessorKwargs):
    """
...
@auto_docstring
class DarkidolImageProcessorFast(BaseImageProcessorFast):
    ...
    valid_kwargs = DarkidolFastImageProcessorKwargs

    def __init__(self, **kwargs: Unpack[DarkidolFastImageProcessorKwargs]):
    ...
    def preprocess(
        self,
        images: ImageInput,
        **kwargs: Unpack[DarkidolFastImageProcessorKwargs],
    ) -> BatchFeature:
...
__all__ = ["DarkidolImageProcessorFast"]
